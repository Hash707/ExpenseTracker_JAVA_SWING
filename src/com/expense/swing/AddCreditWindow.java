...
public class AddCreditWindow extends JFrame {

    public AddCreditWindow(UserProfile profile) {
        setTitle("Add Credit");
        setSize(400, 400);
        ...
        // Title Label
        JLabel titleLabel = new JLabel("CREDIT", SwingConstants.CENTER);
        ...
        confirmButton.addActionListener((ActionEvent e) -> {
            ...
            Operations.addCredit(profile, tData);
            JOptionPane.showMessageDialog(this, "Credit added successfully.");
